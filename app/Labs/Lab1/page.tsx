...
<ul id="wd-my-books">
  ...
  <li>The Forever War</li>
      ...
      <div id="wd-images">
        ...
        <img src= "https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" width={400} height={225}/>
        <p>Loading a local image:</p>
        <Image src="/Images/teslabot.jpg" width={200} height={325} alt="telsa bot"/>
      </div>
        <div id="wd-forms">
  <h4>Form Elements</h4>
  <form id="wd-text-fields">
    ...
    <input type="text" id="wd-text-fields-last-name" placeholder="e.g., Doe"
